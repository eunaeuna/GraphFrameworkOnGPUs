...
&\textbf{PCI} & \textbf{SXM} &
\rowname{(P100-16~GB) \small\textbf{BFS}}&
...
\rowname{(V100-16~GB) \small\textbf{BFS}}&
...
\rowname{(V100-32~GB) \small\textbf{BFS}}&
...
\centering\begin{tabular}{@{}c@{ }c@{ }c@{ }}
& \textbf{PCI} & \textbf{SXM} &
\rowname{(P100-16~GB) \small\textbf{CC}}&
...
\rowname{(V100-16~GB) \small\textbf{CC}}&
...
\rowname{(V100-32~GB) \small\textbf{CC}}&
...
% 4)    Memory access latency: 16~GB system is faster than 32~GB system if the memory size can handle the computation; V100 16~GB often shows better performance than V100 32~GB\@.
...
% 1.    V100 16~GB is the winner in most of case
...
% 1.    Memory intensive computation deteriorated V100 16~GB performance for handing memory management; V100 32~GB is the winner in BC unlike PR and BFS
...
%[Euna] V100 SXM 32~GB data is not collected yet
...
% %1.   V100 SXM 32~GB data is not collected yet
...
% 6.    V100 32~GB: Gunrock opt sometimes appears slower than def with uk2005 and twitter graphs.
...
% 3.    V100 SXM 32~GB data is not collected yet
